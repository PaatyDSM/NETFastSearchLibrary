...
namespace NETFastSearchLibrary
{
    internal class FileDelegateSearch: FileSearchBase
    {
        ...
        public FileDelegateSearch(string folder, Func<FileInfo, bool> isValid, ExecuteHandlers handlerOption): base(folder, handlerOption)
        {
            this.isValid = isValid;
        }


        public FileDelegateSearch(string folder, Func<FileInfo, bool> isValid): this(folder, isValid, ExecuteHandlers.InCurrentTask)
        {
        }


        public FileDelegateSearch(string folder): this(folder, (arg) => true, ExecuteHandlers.InCurrentTask)
        {
        }
