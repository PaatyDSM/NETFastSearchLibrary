...
namespace NETFastSearchLibrary
{
    internal class FileCancellationDelegateSearch : FileCancellationSearchBase
    {
        ...
        public FileCancellationDelegateSearch(string folder, Func<FileInfo, bool> isValid, ExecuteHandlers handlerOption, bool suppressOperationCanceledException, CancellationToken token)
